...
public class DeckDatas {
    ...
    private static Deck enemyDeckInStoryGameLevel3 = new Deck("enemyDeckInStoryGameLevel3", AssetDatas.getArash(), AssetDatas.getHellFire(), AssetDatas.getAllDisarm(), AssetDatas.getDispel(), AssetDatas.getPowerUp(), AssetDatas.getAllPower(), AssetDatas.getAllAttack(), AssetDatas.getWeakening(), AssetDatas.getFarsChief(), AssetDatas.getTooraniArcher(), AssetDatas.getTooraniSpy(), AssetDatas.getThrowStoneGiant(), AssetDatas.getHogRiderGoblin(), AssetDatas.getHogRiderGoblin(), AssetDatas.getDrainLion(), AssetDatas.getWolf(), AssetDatas.getWizard(), AssetDatas.getWildBoar(), AssetDatas.getPiran(), AssetDatas.getBahman(), AssetDatas.getBigGiant(), AssetDatas.getTerrorHood());
    private static Deck defaultDeck = new Deck("defaultDeck",AssetDatas.getRostam(), AssetDatas.getFarsChief(), AssetDatas.getTiger(), AssetDatas.getTooraniSpy(),AssetDatas.getHellFire(), AssetDatas.getEmpower(), AssetDatas.getAllDisarm(), AssetDatas.getPowerUp(), AssetDatas.getAllDisarm(), AssetDatas.getAllPoison(), AssetDatas.getDispel(), AssetDatas.getSacrifice(), AssetDatas.getShock(), AssetDatas.getFarsArcher(), AssetDatas.getTooraniSpear(), AssetDatas.getTooraniSwampy(), AssetDatas.getEagle(), AssetDatas.getEagle(), AssetDatas.getThrowFireDragon(), AssetDatas.getTiger(), AssetDatas.getElf(),AssetDatas.getBaptism());
