...
//    protected final int EXIT = 1234;
//    protected final int CONTINUE = 12345;
    protected final int PRIZE = 1000;
    protected int turn;
    ...
    public void selectWarrior(Account player, int cardID, String inGameCardID) {
        int playerIndex = 0;
        Warrior warrior;
        if (player == players[1])
            playerIndex = 1;
